        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DailyOrderCount = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationUser_PreferredLanguage",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuItem_CategoryId_IsAvailable",
                table: "MenuItems",
                columns: new[] { "CategoryId", "IsAvailable" });

            migrationBuilder.CreateIndex(
                name: "IX_MenuItem_IsAvailable",
                table: "MenuItems",
                column: "IsAvailable");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_OrderDate_Status",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Order_Status_CustomerId",
                table: "Orders",
